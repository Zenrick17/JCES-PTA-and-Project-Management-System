...
<div class="space-y-6">
	...
	<div class="bg-white rounded-lg shadow p-6">
		<div class="flex items-center justify-between">
			...
			<div class="flex items-center gap-3">
				...
				<a href="{{ route('administrator.reports.export', request()->query()) }}" 
	...
	<!-- Filters -->
	<div class="bg-white rounded-lg shadow p-6">
		<form method="GET" action="{{ route('administrator.reports.activity-logs') }}" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
			<div>
