...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between mb-3">
            ...
            <?php if($latestReconciliation): ?>
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                    <?php echo e($latestReconciliation->reconciliation_status === 'completed' ? 'bg-green-100 text-green-800' : ($latestReconciliation->reconciliation_status === 'discrepancy_found' ? 'bg-red-100 text-red-800' : 'bg-yellow-100 text-yellow-800')); ?>">
                    <?php echo e(ucwords(str_replace('_', ' ', $latestReconciliation->reconciliation_status))); ?>
        ...
        <?php if($latestReconciliation): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                <div>
                    ...
                    <p class="font-semibold text-gray-900"><?php echo e($latestReconciliation->reconciliation_period); ?></p>
                </div>
                <div>
                    <p class="text-gray-500">Date Reconciled</p>
                    <p class="font-semibold text-gray-900"><?php echo e(\Illuminate\Support\Carbon::parse($latestReconciliation->reconciled_date)->format('M d, Y')); ?></p>
                </div>
                <div>
                    <p class="text-gray-500">Discrepancy</p>
                    <p class="font-semibold <?php echo e((float)$latestReconciliation->discrepancy_amount > 0 ? 'text-red-600' : 'text-green-600'); ?>">
                        ₱<?php echo e(number_format($latestReconciliation->discrepancy_amount, 2)); ?>

                    </p>
                </div>
                <div>
                    <p class="text-gray-500">Reconciled By</p>
                    <p class="font-semibold text-gray-900"><?php echo e(trim($latestReconciliation->reconciled_by_name) ?: 'N/A'); ?></p>
                </div>
            </div>
        <?php else: ?>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900"><?php echo e(number_format($recentActivityCount)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-red-600"><?php echo e(number_format($failedActionsCount)); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-600"><?php echo e(number_format($uniqueUsersCount)); ?></p>
                </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="space-y-3">
            <?php $__currentLoopData = array_slice($topActions, 0, 5, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $action => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div class="w-3 h-3 bg-green-500 rounded-full"></div>
                    <span class="text-sm font-medium text-gray-700 capitalize"><?php echo e(str_replace('_', ' ', $action)); ?></span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="w-32 bg-gray-200 rounded-full h-2">
                        <div class="bg-green-500 h-2 rounded-full" style="width: <?php echo e(max(10, ($count / array_values($topActions)[0]) * 100)); ?>%"></div>
                    </div>
                    <span class="text-sm font-semibold text-gray-900 w-8 text-right"><?php echo e($count); ?></span>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <a href="<?php echo e(route('principal.reports.activity-logs')); ?>" 
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <a href="<?php echo e(route('principal.reports.user-activity')); ?>" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <a href="<?php echo e(route('principal.reports.payments')); ?>" 
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <a href="<?php echo e(route('principal.reports.enrollment')); ?>" 
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <a href="<?php echo e(route('principal.reports.participation')); ?>" 
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <a href="<?php echo e(route('principal.reports.project-analytics')); ?>" 
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <a href="<?php echo e(route('principal.reports.financial-summary')); ?>" 
               class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200">
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <a href="<?php echo e(route('principal.reports.kpis')); ?>" 
...
<?php echo $__env->make('layouts.pr-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Web Developement\JCES-PTA and Project Management System\resources\views/principal/reports/index.blade.php ENDPATH**/ ?>