                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $contributions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contribution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-sm text-gray-700">
                                <?php echo e($contribution->parent ? $contribution->parent->first_name . ' ' . $contribution->parent->last_name : 'Unknown Parent'); ?>

                            </td>
                            <td class="px-4 py-3 text-sm text-gray-700"><?php echo e($contribution->project?->project_name ?? 'Unknown Project'); ?></td>
                            <td class="px-4 py-3 text-sm text-gray-900 text-right font-medium">₱<?php echo e(number_format($contribution->contribution_amount, 2)); ?></td>
                            <td class="px-4 py-3 text-sm text-gray-700"><?php echo e(strtoupper($contribution->payment_method)); ?></td>
                            ...
                            <td class="px-4 py-3 text-sm text-center">
                                <?php if($contribution->receipt_number): ?>
                                    <button onclick="viewReceipt(<?php echo e($contribution->contributionID); ?>)" class="text-green-600 hover:text-green-700 text-sm font-medium">
...
const allParents = <?php echo json_encode($parents); ?>;
...
function submitManualPayment() {
    ...
    fetch('<?php echo e(route("teacher.payments.submit-manual")); ?>', {
        method: 'POST',
        body: formData,
        headers: {
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.te-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Web Developement\JCES-PTA and Project Management System\resources\views/teacher/payment/index.blade.php ENDPATH**/ ?>