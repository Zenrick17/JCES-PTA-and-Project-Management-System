...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="GET" action="<?php echo e(route('teacher.users')); ?>" class="space-y-4">
            <!-- Main Search Bar -->
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <a href="<?php echo e(route('teacher.users')); ?>" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 flex items-center gap-2 transition-colors duration-200">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <tr class="hover:bg-gray-50" data-user-id="<?php echo e($user->userID); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                <?php if($user->user_type == 'parent'): ?> bg-blue-100 text-blue-800
                                <?php elseif($user->user_type == 'teacher'): ?> bg-green-100 text-green-800
                                <?php elseif($user->user_type == 'administrator'): ?> bg-purple-100 text-purple-800
                                <?php elseif($user->user_type == 'principal'): ?> bg-yellow-100 text-yellow-800
                                <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                <?php echo e(ucfirst($user->user_type ?? 'Unknown')); ?>
...
<?php echo $__env->make('layouts.te-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Web Developement\JCES-PTA and Project Management System\resources\views/teacher/users.blade.php ENDPATH**/ ?>