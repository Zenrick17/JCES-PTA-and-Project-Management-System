...
<head>
    ...
    <title>Principal Dashboard - <?php echo e(config('app.name', 'JCES-PTA')); ?></title>
        ...
        <div id="sidebar" class="sidebar bg-gradient-to-b from-green-500 to-green-600 flex flex-col overflow-hidden">
            ...
            <nav class="flex-1 px-3 py-6 space-y-2">
                <a href="<?php echo e(route('principal.dashboard')); ?>"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 text-white <?php echo e(request()->routeIs('principal.dashboard') ? 'bg-green-700' : 'hover:bg-green-700'); ?> rounded-lg font-medium transition-colors">
                    ...
                    <span class="sidebar-label" x-cloak>Dashboard</span>
                                 ...
                                 <a href="<?php echo e(route('principal.announcements')); ?>"
                                     class="sidebar-link flex items-center gap-3 px-4 py-3 text-white <?php echo e(request()->routeIs('principal.announcements') ? 'bg-green-700' : 'hover:bg-green-700'); ?> rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span class="sidebar-label" x-cloak>Announcement</span>
                                ...
                                <a href="<?php echo e(route('principal.projects.index')); ?>"
                                     class="sidebar-link flex items-center gap-3 px-4 py-3 text-white <?php echo e(request()->routeIs('principal.projects*') ? 'bg-green-700' : 'hover:bg-green-700'); ?> rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span class="sidebar-label" x-cloak>Projects</span>
                     ...
                     <a href="<?php echo e(route('principal.contributions.index')); ?>"
                         class="sidebar-link flex items-center gap-3 px-4 py-3 text-white <?php echo e(request()->routeIs('principal.contributions*') ? 'bg-green-700' : 'hover:bg-green-700'); ?> rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="<?php echo e(route('principal.users')); ?>"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 text-white <?php echo e(request()->routeIs('principal.users') ? 'bg-green-700' : 'hover:bg-green-700'); ?> rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="<?php echo e(route('principal.create-account')); ?>"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 text-white <?php echo e(request()->routeIs('principal.create-account') ? 'bg-green-700' : 'hover:bg-green-700'); ?> rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="<?php echo e(route('principal.reports')); ?>"
                   class="sidebar-link flex items-center gap-3 px-4 py-3 text-white <?php echo e(request()->routeIs('principal.reports*') ? 'bg-green-700' : 'hover:bg-green-700'); ?> rounded-lg font-medium transition-colors">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="<?php echo e(route('profile.edit')); ?>" class="sidebar-profile flex items-center gap-3 px-4 py-3 text-white hover:bg-green-700 rounded-lg font-medium transition-colors w-full">
                    <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                        <span class="text-green-600 font-semibold text-sm">
                            <?php echo e(strtoupper(substr(Auth::user()->first_name ?? Auth::user()->username ?? 'U', 0, 1) . substr(Auth::user()->last_name ?? '', 0, 1))); ?>

                        </span>
                    </div>
                    <div class="text-white sidebar-label" x-cloak>
                        <div class="text-sm font-semibold"><?php echo e(Auth::user()->name ?? Auth::user()->username ?? 'Principal'); ?></div>
...
<?php /**PATH C:\xampp\htdocs\Web Developement\JCES-PTA and Project Management System\resources\views/layouts/pr-sidebar.blade.php ENDPATH**/ ?>